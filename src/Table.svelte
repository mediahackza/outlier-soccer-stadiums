<div class="title"><h3>Stadium Attendance 2014-2019</h3></div>

<div class="table-holder">
  <table class="table table-bordered table-hover table-condensed">
    <thead
      ><tr
        ><th title="Field #1">Season</th>
        <th title="Field #2">Club</th>
        <th title="Field #3">Stadium</th>
        <th title="Field #4">Capacity</th>
        <th title="Field #5">Matches</th>
        <th title="Field #6">Sold Out</th>
        <th title="Field #7">Average Spectators</th>
        <th title="Field #8">Average Percentage</th>
      </tr></thead
    >
    <tbody
      ><tr>
      ...
      <tr>
        <td>2014/15</td>
        <td>Bloemfontein Celtics</td>
        <td>Dr Petrus Molemela </td>
      ...
      <tr>
        ...
        <td>Lucas Masterpieces Moripe </td>
      ...
      <tr>
        <td>2015/16</td>
        <td>Mpumalanga Black Aces FC</td>
        <td>Mbombela </td>
        <td align="right">55,000</td>
        <td align="right">13</td>
        <td align="right">1</td>
      ...
      <tr>
        <td>2015/16</td>
        <td>Lamontville Golden Arrows</td>
        <td>Sugar Ray Xulu </td>
